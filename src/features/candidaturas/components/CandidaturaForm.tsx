...
export function CandidaturaForm() {
  ...
  function handleArquivoChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    setArquivo(file);
    if (file) setCurriculoTexto(""); // arquivo tem prioridade sobre texto colado
  }
  ...
  return (
    <div className="p-4 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-1">Cadastrar Currículo</h1>
      {vaga && <p className="text-gray-500 mb-4">para a vaga: {vaga.titulo}</p>}
